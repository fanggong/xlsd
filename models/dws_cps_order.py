...
class DwsCpsOrder(Base):
    __tablename__ = 'dws_cps_order'
    ...
    def __repr__(self):
        return f'<DwsCpsOrder(o_id="{self.o_id}, order_create_time="{self.order_create_time}", anchor_id="{self.anchor_id}")>'